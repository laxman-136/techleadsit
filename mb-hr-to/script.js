...
function initHeadlineSwapping() {
    ...
    const headlines = {
        A: "Your HR Degree Got You In the Room. Oracle Fusion HCM Keeps You There.",
        B: "Your HR Degree Got You In the Room. Oracle Fusion HCM Keeps You There.",
        C: "Your HR Degree Got You In the Room. Oracle Fusion HCM Keeps You There."
    };
